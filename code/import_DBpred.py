...
def MCNN_data_load(DATA_TYPE,NUM_CLASSES,NUM_DEPENDENT):
    ...
    path_x_train = "/mnt/D/jupyter/DB_pred_github/dataset/Series"+str(MAXSEQ)+"/" + DATA_TYPE +"/Train"
    path_y_train = "/mnt/D/jupyter/DB_pred_github/data/FASTA/Train/label"
    x_train,y_train=data_load(path_x_train,path_y_train,NUM_CLASSES)
    path_x_test = "/mnt/D/jupyter/DB_pred_github/dataset/Series"+str(MAXSEQ)+"/" + DATA_TYPE +"/Test"
    path_y_test =  "/mnt/D/jupyter/DB_pred_github/data/FASTA/Test/label"
